...
class Pengurus_akun extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('superadmin/pengurus_akun/index', $data);
    ...
    public function detail($id_user)
    {
        ...
        $this->load->view('templates/superadmin/sidebar', $data);
        $this->load->view('templates/superadmin/topbar', $data);
        $this->load->view('superadmin/pengurus_akun/detail', $data);
        $this->load->view('templates/superadmin/footer', $data);
    }
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/superadmin/sidebar', $data);
            $this->load->view('templates/superadmin/topbar', $data);
            $this->load->view('superadmin/pengurus_akun/tambah', $data);
            $this->load->view('templates/superadmin/footer', $data);
        } else {
            ...
            redirect('superadmin/pengurus_akun', 'refresh');
        }
    }
    ...
    public function edit($id_user)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('templates/superadmin/sidebar', $data);
            $this->load->view('templates/superadmin/topbar', $data);
            $this->load->view('superadmin/pengurus_akun/edit', $data);
            $this->load->view('templates/superadmin/footer', $data);
        } else {
