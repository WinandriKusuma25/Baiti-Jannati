...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class=" card-body border-bottom-primary">
            ...
            <form method="post" action="<?= base_url('superadmin/transaksi_tunai/filter'); ?>">
                ...
                <div class=" form-group row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <a href="<?php echo base_url("superadmin/transaksi_tunai"); ?>" class="btn btn-danger"> <i
            ...
            <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class='btn btn-circle btn-primary'
                                    href='<?= base_url() . 'superadmin/transaksi_tunai/detail/' . $dnk->id_donasi ?>'
                                    class='btn btn-biru'>
                ...
                <a href="<?php echo base_url('superadmin/transaksi_tunai/tampilKeuangan') ?>"
                ...
                <a href="<?php echo base_url('superadmin/transaksi_tunai/tampilNonKeuangan') ?>"
                    class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fa fa-eye"></i>
