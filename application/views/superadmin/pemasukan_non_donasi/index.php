...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <small>
            <div class="text-muted"> Manajemen Donasi&nbsp;/&nbsp; <a
                    href="<?php echo base_url("superadmin/pemasukan_non_donasi"); ?>">
    ...
    <div class="card shadow mb-4">
        ...
        <div class=" card-body border-bottom-primary">
            ...
            <form method="post" action="<?= base_url('superadmin/pemasukan_non_donasi/filter'); ?>">
                ...
                <div class=" form-group row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <a href="<?php echo base_url("superadmin/pemasukan_non_donasi"); ?>" class="btn btn-danger"> <i
                        ...
                        <tr>
                            ...
                            <td style=" text-align: center;">
                                <a class='btn btn-circle btn-primary'
                                    href='<?= base_url() . 'superadmin/pemasukan_non_donasi/detail/' . $dt->id_pemasukan ?>'
                                    class='btn btn-biru'>
