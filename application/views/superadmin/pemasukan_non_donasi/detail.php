    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <small>
            <div class="text-muted"> Manajemen donasi &nbsp;/&nbsp; Pemasukan Non donasi &nbsp; /&nbsp; <a
                    href="<?= base_url() . 'superadmin/pemasukan_non_donasi/detail/' . $ad->id_pemasukan ?>">Detail
            ...
            <div class="col">
                ...
                <div class="card-body  border-bottom-primary">
                    ...
                    <h6 class="card-title text-dark"><b>Terakhir di edit</b>&nbsp;:
                        ...
                        <?php endforeach ?>
                        <p>
                            <a href="<?php echo base_url("superadmin/pemasukan_non_donasi"); ?>"
                                class="btn btn-primary right"> <i class="fas fa-arrow-left"></i>&nbsp;Kembali</a>
                        </p>
                </div>
            </div>
        </div>
