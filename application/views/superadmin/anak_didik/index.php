    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <small>
            <div class="text-muted"> Manajemen Pengguna &nbsp;/&nbsp; <a
                    href="<?php echo base_url("superadmin/anak_didik"); ?>">Anak Didik</a>
            </div>
        </small>
    </div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body border-bottom-primary">
                ...
                <div class="table-responsive">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class='btn btn-circle btn-primary'
                                        href='<?= base_url() . 'superadmin/anak_didik/detail/' . $ad->id_anak_didik ?>'
                                        class='btn  btn-biru'>
                                        <i class="fas fa-eye" aria-hidden="true"></i>
                                    </a>

                                    <a class='btn btn-circle btn-warning'
                                        href="<?= base_url() . 'superadmin/anak_didik/edit/' . $ad->id_anak_didik ?>">
                                        <i class="fas fa-edit" aria-hidden="true"></i>
                                    </a>


                                    <a href="#modalDelete" data-toggle="modal"
                                        onclick="$('#modalDelete #formDelete').attr('action', '<?= site_url('superadmin/anak_didik/hapus/' . $ad->id_anak_didik) ?>')"
                    ...
                    <a href="<?php echo base_url('superadmin/anak_didik/excel') ?>"
                        class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i
                            class="fa fa-file-excel"></i>
                        Unduh Excel</a>

                    <a href="<?php echo base_url('superadmin/anak_didik/pdf') ?>"
