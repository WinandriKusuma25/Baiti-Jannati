...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <small>
            <div class="text-muted"> Manajemen berita&nbsp;/&nbsp; <a
                    href="<?php echo base_url("superadmin/berita"); ?>">
                    Berita Kegiatan</a>
            </div>
        </small>
    </div>
    <div class="card shadow-sm border-bottom-primary">
        ...
        <ul class="list-group list-group-flush">
            <li class="list-group-item"><b> <i class="fas fa-fw fa-newspaper"></i>&nbsp;Jumlah Berita:
                        ...
                        <tr>
                            ...
                            <td>
                                <a class='btn btn-circle btn-primary'
                                    href='<?= base_url() . 'superadmin/berita/detail/' . $ad->id_berita ?>'
                                    class='btn btn-biru'>
                                    <i class="fas fa-eye" aria-hidden="true"></i>
                                </a>

                                <a class='btn btn-circle btn-warning'
                                    href="<?= base_url() . 'superadmin/berita/edit/' . $ad->id_berita ?>">
                                    <i class="fas fa-edit" aria-hidden="true"></i>
                                </a>

                                <a href="#modalDelete" data-toggle="modal"
                                    onclick="$('#modalDelete #formDelete').attr('action', '<?= site_url('superadmin/berita/hapus/' . $ad->id_berita) ?>')"
