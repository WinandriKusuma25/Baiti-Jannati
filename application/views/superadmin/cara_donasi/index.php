...
<div class="container-fluid">
    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body border-bottom-primary">
            ...
            <a class='btn btn-success' href="cara_donasi/tambah">
            ...
            <div class="table-responsive">
                <!-- <b>Jumlah cara_donasi : <?php echo $this->db->get_where('cara_donasi')->num_rows() ?></b> -->
                <table class="table table-bordered table-striped text-center" id="dataTable" width="100%"
                    ...
                    <tbody>
                        <?php $no = 1;
                        foreach ($cara_donasi as $j) : ?>
                        <tr>
                            <td><?= $no++ ?></td>
                            <td><?= $j->pertanyaan ?></td>
                            <td width="50px"><?= $j->jawaban ?></td>
                            ...
                            <td>
                                <!-- <a class='btn btn-primary'
                                    href='<?= base_url() . 'superadmin/cara_donasi/detail/' . $j->id_cara?>'
                                    class='btn btn-biru'>
                                    <i class="fas fa-eye" aria-hidden="true"></i>
                                </a> -->

                                <a class='btn btn-warning btn-circle'
                                    href="<?= base_url() . 'superadmin/cara_donasi/edit/' . $j->id_cara?>">
                                    <i class="fas fa-edit" aria-hidden="true"></i>
                                </a>


                                <a href="#modalDelete" data-toggle="modal"
                                    onclick="$('#modalDelete #formDelete').attr('action', '<?= site_url('superadmin/cara_donasi/hapus/' . $j->id_cara) ?>')"
