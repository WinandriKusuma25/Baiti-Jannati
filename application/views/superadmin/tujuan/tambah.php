...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah tujuan</h1>
        <small>
            <div class="text-muted"> Manajemen Pengguna &nbsp;/&nbsp; tujuan &nbsp; / &nbsp; <a
                    href="<?php echo base_url("superadmin/tujuan/tambah"); ?>">Tambah</a>
            </div>
        </small>
    </div>
    <!-- Content Row -->
        ...
        <div class="col-md-8 py-3">
            ...
            <div class="card shadow-sm">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Form Tambah Data tujuan</h6>
                </div>

                <div class="card-body border-bottom-primary">

                    <form method="post" action="<?= base_url('superadmin/tujuan/tambah'); ?>">

                        <div class="form-group">
                            <label for="tujuan">Judul</label>
