...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Status Pengurus</h1>
        <small>
            <div class="text-muted"> Manajemen Pengguna &nbsp;/&nbsp; Pengurus &nbsp; / &nbsp; <a
                    href="<?php echo base_url("superadmin/pengurus/edit"); ?>">Edit Status</a>
            </div>
        </small>
    </div>
    <!-- Content Row -->
        ...
        <div class="col-md-8 py-3">
            <div class="alert alert-primary" role="alert">
                <h6 class="alert-heading">
                    * Berikut Form untuk mengaktivasi akun pengurus
                </h6>
            </div>
