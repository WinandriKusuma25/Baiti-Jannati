<body>
    <main>
        ...
        <div class="page-hero-section bg-image hero-mini" style="background-image: url(<?= base_url(); ?>assets/user/img/hero_mini.svg);">
                    ...
                    <div class="card-page">
                        <div class="row row-beam-md">
                            <div class="col-md-4 text-center py-3 py-md-2">
                                <img src="<?= base_url(); ?>assets/images/anak_didik/all.png" alt="" width="40%">
                            ...
                            <div class="col-md-4 text-center py-3 py-md-2">
                                <img src="<?= base_url(); ?>assets/images/anak_didik/laki.png" alt="" width="40%">
                            ...
                            <div class="col-md-4 text-center py-3 py-md-2">
                                <img src="<?= base_url(); ?>assets/images/anak_didik/cewek.png" alt="" width="40%">
                ...
                <div class="row justify-content-center">
                    ...
                    <?php foreach ($anak_didik as $ad) : ?>
                        <div class="card-page mr-3 ml-3 mb-3 " style="width:340px; height:500px">
                            ...
                            <center><img src="<?= base_url('assets/images/anak_didik/') . $ad->foto ?>" style="width:240px; height:250px;">
                                <br>
