            ...
            <div class="hero-caption">
                <div class="container fg-white h-100">
                    <div class="row justify-content-center align-items-center text-center h-100">
                        <div class="col-lg-6">
                            <h3 class="mb-4 fw-medium">Laporan Pengeluaran Keuangan</h3>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb breadcrumb-dark justify-content-center bg-transparent">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Laporan Pengeluaran Keuangan
                                    </li>
                                </ol>
                            </nav>
                        </div>
        ...
        <div class="container mr-12  wow fadeInUp">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col">
                        <div class="card-page">
                            <h5 class="fg-primary">Laporan Pengeluaran Keuangan</h5>
                            <hr>
                            <center>
                                <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                    src="<?= base_url(); ?>assets/images/date.svg" alt="">
                            </center>
                            <center> Berikut Merupakan Halaman Laporan Pengeluaran Keuangann <b>Baiti
                                    Jannati</b>
                            </center>
                            <center>
                                <hr width="50%">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 mb-3" id="tanggalfilter">
                                    <div class="card card-primary shadow-sm">
                                        ...
                                        <div class="card-body">
                                            <form action="<?php echo base_url("Laporan_pengeluaran/filter"); ?>"
