<?php $no = 1;
    foreach ($transaksi_midtrans as $p) : ?>
<?php if ($p->payment_type == "echannel") : ?>
<!-- Begin Page Content -->
    ...
    <div class="row">
        <div class="col-xl-7 col-lg-7">
            <div class="card  shadow border-bottom-primary">
                ...
                <div class="card-text">&nbsp;&nbsp; Biller Code :&nbsp;<b><?= $ad->biller_code ?></b></div>
                <div class="card-text">&nbsp;&nbsp; Bill Key :&nbsp;<b><?= $ad->bill_key ?></b></div>
...
<?php elseif ($p->payment_type == "cstore") : ?>
    ...
    <div class="row">
        <div class="col-xl-7 col-lg-7">
            <div class="card  shadow border-bottom-primary">
                ...
                <div class="card-text">&nbsp;&nbsp; Tgl. Transaksi
                    :&nbsp;<b><?=  date('d-m-Y H:i:s', strtotime($ad->transaction_time)); ?></b></div>
                <div class="card-text">&nbsp;&nbsp; Kode Payment :&nbsp;<b><?= $ad->payment_code ?></b></div>
                <?php if ($ad->status_code == "200") : ?>
                <div class="project-state">
                    &nbsp;&nbsp;&nbsp;Status Pembayaran : <span class="badge badge-success"> Sukses</span>
                </div>
