    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <small>
            <div class="text-muted"> Manajemen Laporan &nbsp;/&nbsp; <a
                    href="<?php echo base_url("admin/laporan"); ?>">Laporan Pemasukan dan Pengeluaran Keuangan</a>
            </div>
        </small>
    </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-8 col-lg-8">
                <div class="card card-primary shadow-sm border-bottom-primary">
                    ...
                    <div class="card-body">
                        <form action="<?php echo base_url("admin/laporan/filter"); ?>" method="POST" target='_blank'>
