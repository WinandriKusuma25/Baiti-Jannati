                    ...
                    <form method="post" action="<?= base_url('admin/transaksi_tunai/tambah'); ?>"
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-6">
                                ...
                                <input type="text" id="jenis_non_keuangan" value="Non Keuangan" readonly
                                    class="form-control">
                            </div>
                            ...
                            <div class="form-group col-3">
                                <label>Jumlah</label>
                                <input type="number" name="jumlah" id="jumlah" value="" class="form-control" min="1">
                            </div>
                        </div>
                        ...
                        <div class="keranjang">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="table-donasi">
                                    <thead>
                                        <tr>
                                            <th class=" text-primary" width="5%">No</th>
                                            <th class="text-primary" width="15%">Jenis Donasi</th>
...
// @TODO 1 : Ambil event Non Keuangan
$('#tambah-non-keuangan').on('click', function() {
    ...
    if ($jumlah.length > 0) {
        ...
        $('#jumlah').css('border', '1px solid red');
    }
    ...
    if (kondisiValidasi == 1) {
        ...
        // clear all component
        $('#jenis_non_keuangan').val("Non Keuangan");
        $('#jumlah').val(null);
        $('#keterangan-nk').val(null);
