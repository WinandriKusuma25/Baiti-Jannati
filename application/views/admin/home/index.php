        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div class="card-header bg-primary py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-white">Total Transaksi Barang Perbulan pada Tahun
                        <?= date('Y'); ?>
                    </h6>
                </div>
                <!-- Card Body -->
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        <span class="mr-2">
                            <i class="fas fa-circle text-primary"></i> Donasi Tunai
                        </span>
                        <span class="mr-2">
...
var myPieChart = new Chart(ctx, {
    type: 'doughnut',
    data: {
        labels: ["Donasi Tunai", "Donasi Non Keuangan"],
        datasets: [{
            data: [
...
var myLineChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: "Total Transaksi Non Keuangan",
            lineTension: 0.3,
