...
<div class="container-fluid">
    ...
    <div class="card   shadow border-bottom-primary">
        ...
        <ul class="list-group list-group-flush">
            <li class="list-group-item"><b> <i class="fas fa-fw fa-user-tie"></i>&nbsp;Jumlah Kategori:
                    <?php echo $this->db->get_where('kategori')->num_rows() ?></b>
                <hr>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Berikut merupakan data kategori</h6>
        </div>
        <div class="card-body border-bottom-primary">
            <?= $this->session->flashdata('message'); ?>
            <a class='btn btn-success' href="kategori/tambah">
            ...
            <div class="table-responsive">
                <!-- <b>Jumlah kategori : <?php echo $this->db->get_where('kategori')->num_rows() ?></b> -->
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- <a class='btn btn-primary'
                                    href='<?= base_url() . 'admin/kategori/detail/' . $j->id_kategori ?>'
                                    class='btn btn-biru'>
                                    <i class="fas fa-eye" aria-hidden="true"></i>
                                </a> -->

                                <a class='btn btn-warning btn-circle'
                                    href="<?= base_url() . 'admin/kategori/edit/' . $j->id_kategori ?>">
                                    <i class="fas fa-edit" aria-hidden="true"></i>
                                </a>


                                <a href="#modalDelete" data-toggle="modal"
                                    onclick="$('#modalDelete #formDelete').attr('action', '<?= site_url('admin/kategori/hapus/' . $j->id_kategori) ?>')"
