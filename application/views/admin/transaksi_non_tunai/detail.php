...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <?php $no = 1;
        foreach ($transaksi_midtrans as $ad) : ?>
        <small>
            <div class="text-muted"> Manajemen donasi &nbsp;/&nbsp; Transaksi Transfer &nbsp; /&nbsp; <a
                    href="<?= base_url() . 'admin/transaksi_non_tunai/detail/' . $ad->order_id ?>">Detail
    ...
    <div class="row">
        <div class="col-xl-7 col-lg-7">
            <div class="card  shadow border-bottom-primary">
                ...
                <p>
                <p>
                    &nbsp;&nbsp; <a href="<?php echo base_url("admin/transaksi_non_tunai"); ?>" class="btn btn-primary">
