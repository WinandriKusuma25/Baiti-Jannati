                    ...
                    <div class="col-lg">
                        <div class="p-5">
                            <div class="text-center">
                                ...
                                <center><img src="<?= base_url(); ?>assets/images/logo.png" alt="" width="30%"></center>
                                <br>
                            </div>
                            <form class="user" method="post" action="<?= base_url('auth/registration') ?>">
                                ...
                                <div class=" form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password"
                                            class="form-control form-control-user  border-left-primary" id="password1"
                                            name="password1" placeholder="Password">
                                        <?= form_error('password1', '<small class="text-danger pl-3">', '</small>'); ?>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="password"
                                            class="form-control form-control-user  border-left-primary" id="password2"
                            ...
                            <div class="text-center">
                                <a class="small" href="<?= base_url('auth'); ?>">Apakah Anda Sudah Punya Akun? Login</a>
                            </div>
                        </div>
                    </div>
                </div>
