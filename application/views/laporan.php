            ...
            <div class="hero-caption">
                <div class="container fg-white h-100">
                    <div class="row justify-content-center align-items-center text-center h-100">
                        <div class="col-lg-6">
                            <h3 class="mb-4 fw-medium">Laporan</h3>
        ...
        <div class="page-section pt-5">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col">
                        <div class="card-page">
                            <h5 class="fg-primary">Laporan Donasi dan Keuangan Baiti Jannati</h5>
                            <hr>
                            <center>
                                <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                    src="<?= base_url(); ?>assets/images/date.svg" alt="">
                            </center>
                            <center> Berikut Merupakan Halaman Manajemen Laporan Donasi dan Keuangan <b>Baiti
                                    Jannati</b>
                            </center>
                            <p>
                            ...
                            <div class="col">
                                ...
                                <p>
                                    ...
                                    <i class="fas fa-download"></i> Unduh Pemasukan Keuangan
                                </a>

                                <a href="<?= base_url('profile') ?>" class="btn btn-primary rounded-pill">
                                    <i class="fas fa-download"></i> Unduh Pengeluaran Keuangan
                                </a>

                                <a href="<?= base_url('profile') ?>" class="btn btn-primary rounded-pill">
                                    <i class="fas fa-download"></i> Unduh Pemasukan dan Pengeluaran Keuangan
                                </a>

                                <a href="<?= base_url('profile') ?>" class="btn btn-primary rounded-pill">
                                    <i class="fas fa-download"></i> Unduh Pemasukan Donasi Non Keuangan
                                </a> -->
                            </div>
